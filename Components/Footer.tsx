        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 relative rounded-xl border border-[#F39C12]/40 backdrop-blur-sm bg-white/10 flex items-center justify-center overflow-hidden">
                <img
                  src="/logo.png"
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a
                ...
                aria-label="Facebook"
                className="bg-gradient-to-br from-[#2C1810] to-[#1A0F0A] p-3 rounded-xl border-2 border-[#F39C12] hover:border-[#F5B041] hover:scale-110 transform transition-all duration-300"
              >
