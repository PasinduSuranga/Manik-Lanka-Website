      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <h2 className="text-3xl font-bold text-[#2C4A52] mb-2">Send Us a Message</h2>
              <div className="w-20 h-1 bg-gradient-to-r from-[#F59E42] to-[#E88B2F] mb-8 rounded-full" />
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="flex h-12 w-full rounded-xl border-2 border-[#F5E6D3] bg-white px-4 py-2 text-[#1A1A1A] placeholder:text-[#6B7280] focus:outline-none focus:ring-2 focus:ring-[#F59E42] focus:border-transparent disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-300"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows={6}
                    disabled={isSubmitting}
                    className="flex min-h-[120px] w-full rounded-xl border-2 border-[#F5E6D3] bg-white px-4 py-3 text-[#1A1A1A] placeholder:text-[#6B7280] focus:outline-none focus:ring-2 focus:ring-[#F59E42] focus:border-transparent disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-300 resize-none"
                  />
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-gradient-to-r from-[#F59E42] to-[#E88B2F] hover:from-[#E88B2F] hover:to-[#F59E42] text-white font-semibold h-12 px-6 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div className="space-y-8">
              ...
              >
                <h2 className="text-3xl font-bold text-[#2C4A52] mb-2">Contact Information</h2>
                <div className="w-20 h-1 bg-gradient-to-r from-[#F59E42] to-[#E88B2F] mb-8 rounded-full" />
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div>
                      <h3 className="text-[#2C4A52] font-bold mb-1 text-lg">Address</h3>
                      <p className="text-[#6B7280]">No. 67/C, Walpola, Ragama, Sri Lanka</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div>
                      <h3 className="text-[#2C4A52] font-bold mb-1 text-lg">Phone</h3>
                      <p className="text-[#6B7280]">+94 77 767 3814</p>
                  ...
                  >
                    ...
                    <div>
                      <h3 className="text-[#2C4A52] font-bold mb-1 text-lg">Email</h3>
                      <p className="text-[#6B7280]">mlankaholidays@gmail.com</p>
                  ...
                  >
                    ...
                    <div>
                      <h3 className="text-[#2C4A52] font-bold mb-1 text-lg">Business Hours</h3>
                      <p className="text-[#6B7280]">Monday - Friday: 9:00 AM - 5:30 PM</p>
                      <p className="text-[#6B7280]">Saturday, Sunday: Closed</p>
                    </div>
                  </motion.div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-[#2C4A52] via-[#2C4A52] to-[#1e363d] rounded-3xl shadow-2xl p-8 text-white"
              >
              ...
              <motion.div
                ...
                className="bg-white rounded-3xl shadow-2xl p-8 border border-[#F59E42]/10"
              >
                <h3 className="text-2xl font-bold text-[#2C4A52] mb-2">Find Us</h3>
                <div className="w-20 h-1 bg-gradient-to-r from-[#F59E42] to-[#E88B2F] mb-6 rounded-full" />
