  ...
  return (
    <div className="min-h-screen bg-[#FDFCFA] overflow-x-hidden">
      ...
      <section className="relative h-[65vh] sm:h-[75vh] min-h-[520px] max-h-[860px] overflow-hidden">
        <Image src="https://res.cloudinary.com/bnhex8aj/image/upload/v1783588315/Hero_Section_kbtqqp.png" alt="Contact Manik Lanka Holidays" fill priority className="object-cover contact-hero-img" style={{ filter: 'brightness(0.65) saturate(1.05)' }} />
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden" ref={ctaReveal.ref}>
        <div className="absolute inset-0">
          <Image src="https://res.cloudinary.com/bnhex8aj/image/upload/v1783588320/Bottom_Section_ktlv0u.png" alt="Sri Lanka" fill className="object-cover object-center" style={{ filter: 'brightness(0.55) saturate(1.1)' }} />
